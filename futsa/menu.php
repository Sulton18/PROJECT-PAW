              ...
              <li><a href="http://localhost/futsal/adm/" data-target="#kode"><i class="glyphicon glyphicon-list-alt"></i> Login Admin</a></li>
              <li><a href="http://localhost/futsal/kasir/" data-target="#kode"><i class="glyphicon glyphicon-list-alt"></i> Login Kasir</a></li>
			  <?php
			  }
			  ?>
            </ul>