...
<div id="header">
  <div align="center">
    <p><span class="style1">SULTON</span><br> 
Jl. raya telang, utara pertigaan UTM telp.(0751)73905 HP. 085704558256 - 085704558256

    <hr> 
    </p>
	
    <strong>Bukti Pembayaran </strong></div>
</div>
<?php
...
<table width="382" border="0" align="center">
  ...
  <tr>
    ...
    <td>: <?php echo number_format($r['harga'],2);echo" ($r[jns])";?></td>
  </tr>
  <tr>
