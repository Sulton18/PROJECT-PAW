...
//jadwal
?>
<h2>Jadwal <?php if($_POST[tanggal]==""){echo"Hari ini";}else{echo"Tanggal : \"$_POST[tanggal]\"";}?></h2>
<p><form method="post"><input type='text' class='input-small' name='tanggal' placeholder='yyyy-mm-dd' value='<?php echo"$_POST[tanggal]"; ?>' /> <input class='btn btn-danger' type='submit' name=submit value='cari' /></form></p>
